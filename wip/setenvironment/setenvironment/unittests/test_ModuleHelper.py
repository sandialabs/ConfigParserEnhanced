...
# Replaces 'class mock_popen_stdout_throws_on_exec(mock_popen)' since,
# on LMOD systems, the popen mock constructor was not matched.
def mock_popen_communicate_stdout_throws_on_exec(cmd):
    """
