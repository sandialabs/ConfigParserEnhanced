...
@pytest.mark.parametrize("keyword", [
    {
        "str": "machine-type-5_intel-19.0.4-mpich-7.7.15-hsw-openmp_static_dbg",
        "qualified_env_name": "machine-type-5_intel-19.0.4-mpich-7.7.15-hsw-openmp",
        "system_name": "machine-type-5",
    },
    {
        "str": "default-env-knl",
        "qualified_env_name": "machine-type-5_intel-19.0.4-mpich-7.7.15-knl-openmp",
        "system_name": "machine-type-5",
    },
    {
        "str": "intel_hsw",
    ...
    {
        "str": "machine-type-3_arm-20.1",
        "qualified_env_name": "machine-type-3_arm-20.1-openmpi-4.0.3-openmp",
        "system_name": "machine-type-3",
    },
    {
        "str": "arm-serial",
        "qualified_env_name": "machine-type-3_arm-20.0-openmpi-4.0.2-serial",
        "system_name": "machine-type-3",
    },
])
...
def test_nonexistent_env_name_or_alias_raises():
    ekp = EnvKeywordParser("bad-kw-str", "machine-type-5", "test_supported_envs.ini")
...
@pytest.mark.parametrize("bad_alias", [
    ...
    },
    {
        ...
        "err_msg": ("ERROR:  Alias found for 'machine-type-5' that matches an "
                    "environment name:"),
    },
    {
