...
class ConfigKeywordParser(GenConfigCommon):
    """
...
# TODO: Pull this out and rename to something like
#       get_values_for_section_key(section, key)
#       - get_aliases will aggregate results from this for all keys in the
#         system_name section.
    def get_aliases(self):
        ...
        self.assert_aliases_do_not_contain_machine-name-4space(alias_list)
...
# TODO: Pull a limited form of this out and rename to something like
#       assert_values_are_unique. We still want to leave this here, though,
#       because it will check for uniqueness across all values for a given
#       section (i.e. system_name)
