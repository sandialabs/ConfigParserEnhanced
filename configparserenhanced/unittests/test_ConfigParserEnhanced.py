...
class ConfigParserEnhancedDataTest(TestCase):
    ...
    def test_ConfigParserDataEnhanced_property_data(self):
        ...
        self.assertTrue(default_section_name in parser.configparserenhanceddata.data.keys())
        print("-----[ TEST END   ]--------------------------------------------------")

        print("-----[ TEST START ]--------------------------------------------------")
        parser.configparserenhanceddata.data = { default_section_name: {} }
        self.assertTrue(default_section_name in parser.configparserenhanceddata.data.keys())
        print("-----[ TEST END   ]--------------------------------------------------")
    ...
    def test_ConfigParserDataEnhanced_keys(self):
        ...
        print("-----[ TEST START ]--------------------------------------------------")
        key_list_expect = [
            parser._internal_default_section_name,     # This is the 'DEFAULT' section (redefined for CPE)
            'SECTION-A',
            'SECTION-B',
            'SECTION C',
            'SECTION-A+',
    ...
    def test_ConfigParserDataEnhanced_sections(self):
        ...
        print("-----[ TEST START ]--------------------------------------------------")
        sec_list_expect = [
            parser._internal_default_section_name,
            'SECTION-A',
            'SECTION-B',
            'SECTION C',
            'SECTION-A+',
